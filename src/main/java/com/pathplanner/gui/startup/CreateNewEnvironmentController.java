...
public class CreateNewEnvironmentController
{
    ...
    public void environmentTypeChoiceBoxAction(ActionEvent event)
    {
        extensionLabel.setText(
                environmentTypeMap.get(environmentTypeChoiceBox.getValue()).getElementsByTagName("extension").item(0).getTextContent()
        );
    }
